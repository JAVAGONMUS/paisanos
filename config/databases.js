...
const sequelizePostgres = process.env.DATABASE_URL 
  ? new Sequelize(process.env.DATABASE_URL, {
      dialect: 'postgres',
      logging: false,
      timezone: 'America/Guatemala', // <-- Fuerza a Sequelize a escribir en formato local de GT
      dialectOptions: {
        useUTC: false, // <-- Evita conversiones automáticas e incorrectas a UTC
        ssl: {
          require: true,
...
module.exports = {
  ...
  authenticateDBs: async () => {
    try {
        ...
        // El log ahora imprimirá automáticamente la hora de la BD respetando el huso de GT
